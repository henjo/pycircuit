...
Collection is **2,783 tests**: 2,696 in `pycircuit/circuit/tests` and 87
...
**2,783 tests collected, no errors.** Before that it aborted during
collection.
...
|---|---:|---:|---:|---:|
| `pycircuit/circuit/tests` | 2,692 | 3 | 3 | **0** |
| rest of the tree | 85 | 3 | 0 | **0** |
| **total** | **2,777** | **6** | **3** | **0** |

⚠ On a BUSY machine this reads **2,776 / 7** instead: the perf guard
...
check worth doing rather than trusting the totals: 2,777 passed + 6
skipped + 3 xfailed = 2,786, less the **3 module-level skips that
collection does not count**, gives **2,783** — the collected total. (It
