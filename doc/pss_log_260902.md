...
⚠ **WHAT THIS STILL DOES NOT DO:** it anchors the VARIANCE and the SLEW, not the claim that crossings scatter by
σ_t. The variance→time conversion remains a definition, and the Monte Carlo that would test it remains A8's
named next step.
