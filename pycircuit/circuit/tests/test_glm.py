...
from pycircuit.circuit.tests.test_stage_predictor import _expg_fixture  # noqa: E402
...
def test_glm_stage_predictor_declines_a_changed_step_and_a_period_seam():
    ...
    tr = Transient(_expg_fixture(), integrator=GLM3Integrator())
    ...
    assert tr._glm_stage_predictor(1e-5, 0.0, c) is not None
