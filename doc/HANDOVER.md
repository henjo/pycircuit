...
| `covariance` under radau/trbdf2 at a switching edge | ⚠ recorded, not fixed: Van Loan injection frozen at the END of each step reads a switched capacitor's held variance 0.876 / 0.934 (400 / 800 points, O(h)) against 0.9987 under gear |
