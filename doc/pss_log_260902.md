...
**VALIDATED AT FACTOR LEVEL, AND THE PERCENT-LEVEL RUN THEN OVERTURNED THE AGREEMENT.** Against **eighty** Monte
Carlo seed-runs — noisy transients with no PSS, no adjoint and no Lyapunov solve in them:

`MC/analysis = 1.0571 ± 0.0141` — **4.04σ from 1.000**
