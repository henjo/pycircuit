...
Collection is **2,776 tests**: 2,689 in `pycircuit/circuit/tests` and 87
...
**2,776 tests collected, no errors.** Before that it aborted during
collection.
...
|---|---:|---:|---:|---:|
| `pycircuit/circuit/tests` | 2,685 | 3 | 3 | **0** |
| rest of the tree | 85 | 3 | 0 | **0** |
| **total** | **2,770** | **6** | **3** | **0** |

⚠ On a BUSY machine this reads **2,769 / 7** instead: the perf guard
...
check worth doing rather than trusting the totals: 2,770 passed + 6
skipped + 3 xfailed = 2,779, less the **3 module-level skips that
collection does not count**, gives **2,776** — the collected total. (It
