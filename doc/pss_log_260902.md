...
⚠ **STILL UNEXPLAINED, recorded rather than averaged away**: gear-2 at 240 points showed a seed-to-seed spread of
**0.152** against Euler's **0.028** on *identical* noise draws and identical run lengths. That is not sampling
noise and I have no account of it. The pooled 1.032 ± 0.033 includes those rows; dropping them gives
0.997 ± 0.016, and I am not quoting that as the headline because discarding the rows that disagree, because they
disagree, is selection.
