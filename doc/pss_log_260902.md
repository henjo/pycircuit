...
**VALIDATED AT FACTOR LEVEL**: against nine Monte Carlo seed-runs — a noisy transient with no PSS, no adjoint and
no Lyapunov solve in it — `MC/analysis = 1.032 ± 0.033`, consistent with 1.000 at 0.99σ, factor-2 excluded at
16–30σ. ⚠ The MC's seed spread is 17–41 %, so 3 % would need ~45 seeds (~1.6 h); the test gates the structure and
the invariants, not the percent.
