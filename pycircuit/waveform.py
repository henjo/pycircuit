"""The waveform module contains classes for handling simulation results in the form of
X-Y data. The classes can handle results from multi-dimensional sweeps
"""
