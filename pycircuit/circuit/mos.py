...
#        self['Igmb'] = VCCS(self.nodenames['b'], self.nodenames['s'], self.nodenames['d'], self.nodenames['s'], gm=self.ipar.gmb)
        ...
        self['gds'] = G(self.nodenames['d'], self.nodenames['s'], g = self.ipar.gds, nonoise = True)
        ...
        self['idnoise'] = IS(self.nodenames['d'], self.nodenames['s'], i = 0, iac = 0, noisePSD = 4 * Symbol('kT') * self.ipar.gamma * self.ipar.gm)
